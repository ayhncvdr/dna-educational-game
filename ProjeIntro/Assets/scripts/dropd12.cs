...
public class dropd12 : MonoBehaviour
{
    ...
    List<string> d1options = new List<string>() { "üçte biri anneden üçte ikisi babadan", "yarýsý anneden yarýsý babadan" };
    List<string> d2options = new List<string>() { "heterozigot","çekinik","homozigot" };
    List<string> d3options = new List<string>() { "homozigot" ,"dominant"};
    List<string> d4options = new List<string>() { "dominant", "çekinik","heterozigot" };
    List<string> d5options = new List<string>() { "homozigot baskýn", "homozigot çekinik" };
