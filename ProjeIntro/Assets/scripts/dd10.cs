...
public class dd10 : MonoBehaviour
{
    ...
    List<string> d1options = new List<string>() { "kalýtýmdýr", "karekterdir", "gendir" };
    List<string> d2options = new List<string>() { "kalýtýmý", "karakteri", "genleri" };
    List<string> d3options = new List<string>() { "genetik", "genotip", "kalýtým" };
    List<string> d4options = new List<string>() { "genetiklerin", "genotiplerin", "kalýtýmýn" };
    List<string> d5options = new List<string>() { "genotip", "fenotip", "kalýtým" };
